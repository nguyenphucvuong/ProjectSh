...
const AddProduct = ({ route, props }) => {
    ...
    p = route.params.data;
    console.log('url1', p.imagePr.url1);
    ...
    const renderItem = ({ item }) => {
        return (
            <ItemColor
                item={item}
                onPress={() => setSelectedId([{ url: item.imagePr.url1, color: item.colorPr.color1 }])}
                onPress2={() => setSelectedId([{ url: item.imagePr.url2, color: item.colorPr.color2 }])}
                onPress3={() => setSelectedId([{ url: item.imagePr.url3, color: item.colorPr.color3 }])}
