    ...
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color }) => (
            <FontAwesome name="shopping-cart" size={26} color="#000" />
          ),
        }}
      />
      <Tab.Screen
...
const HomeScreen = (navigation) => {
  ...
  const OnchangeCategory = id => {
    ...
    if (id === 1) {
      setAction(1);
      setListSP(list.filter((itemloai) => itemloai.typePr == "Áo"));
      console.log("sp login 111", listSP);
    }
    if (id === 2) {
      setAction(2);
      setListSP(list.filter((itemloai) => itemloai.typePr == "Quần"));
                ...
                {listSP.map((e, index) => (
                  <TouchableOpacity
                    onPress={() => {
                      ...
                      console.log('chuyen man hinh', e.idPr);
                    }}
                  >
                    <View key={index.toString()}>
                      <ProductItem
                        name={e.namePr}
                        image={e.imagePr.url1}
                        price={e.pricePr}
                      />
                    </View>
                  </TouchableOpacity>
